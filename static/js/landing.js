document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        EN: {
            ...
            app: {
                ...
                resources: "Resources",
                select_domain: "Select Domain",
                create_new_domian: "Create New Domain",
                ...
                supported_file: "Supported file types: PDF, Word, Text",
                ...
                feedback_desc_5: "If it helps explain better, attach a screenshot",feedback_screenshot: "Screenshot (Optional)",
        ...
        TR: {
            ...
            app: {
                ...
                resources: "Kaynaklar",
                select_domain: "Domain Seçin",
                create_new_domian: "Yeni Domain Oluştur",
                ...
                supported_file: "Desteklenen dosya türleri: PDF, Word, Metin",
                ...
                logout_title: "ragchat'ten çıkış yapmak istiyor musunuz?",
                logout_alert: "Her zaman geri dönüp giriş yapabilirsiniz.",
                logout_buton: "Çıkış Yap",
        ...
        GE: {
            landing: {
                login: "Anmelden",
                signup: "Registrieren",
                hero_title: "Finden Sie Informationen schnell",
                hero_description: "ragchat ist Ihre KI-gestützte intelligente Bibliothek",
                cta_get_started: "Loslegen",
                explore_now: "Jetzt erkunden",
                about_title: "Was ist ragchat?",
                upload_documents_title: "Dokumente hochladen",
                upload_documents_description: "Laden Sie Ihre Dokumente hoch und verwandeln Sie sie in eine KI-gestützte intelligente Bibliothek. Speichern Sie bis zu 50 MB Dokumente in spezialisierten Ordnern. Unterstützt derzeit PDF-, Word- und Textdateien.",
                chat_information_title: "Chatten, um Informationen zu erhalten",
                chat_information_description: "Chatten Sie mit Ihren Dokumenten durch KI-gestützte natürliche Gespräche. Stellen Sie Fragen in Alltagssprache und erhalten Sie sofortige, präzise Antworten.",
                source_validation_title: "Quellenvalidierung",
                source_validation_description: "Erhalten Sie präzise Quellenangaben für jede Antwort mit Seitenzahlen und direkten Verweisen.",
                connected_documents_title: "Verknüpfte Dokumente",
                connected_documents_description: "Analysieren Sie Beziehungen zwischen mehreren Dokumenten und treffen Sie bessere Entscheidungen mit KI-gestützter Analyse.",
                demo_title: "Erleben Sie ragchat in Aktion",
                personal_researcher_title: "Ihr persönlicher Forscher",
                personal_researcher_description: "Verbessern Sie Ihre akademische Forschung mit ragchat. Analysieren Sie Forschungsarbeiten und erstellen Sie Literaturübersichten effizient.",
                fast_analysis_title: "Schnelle und präzise Analyse",
                fast_analysis_description: "Verwandeln Sie Geschäftsdokumente in umsetzbare Erkenntnisse durch KI-gestützte Gespräche.",
                smart_organization_title: "Intelligente Organisation",
                smart_organization_description: "Verwalten Sie Dokumente mit KI-gestützter Organisation. Rufen Sie Informationen durch natürliche Gespräche ab.",
                info_title: "Über uns",
                mission_title: "Mission",
                mission_description: "Wir revolutionieren den Umgang mit Informationen.",
                who_we_are_title: "Wer wir sind",
                who_we_are_description: "Erstellt von leidenschaftlichen Ingenieuren im KI-Bereich.",
                what_we_do_title: "Was wir tun",
                what_we_do_description: "ragchat ist Ihre intelligente Bibliothek, die natürliche Gespräche mit Ihren Dokumenten ermöglicht.",
                contact_title: "Kontakt",
                contact_description: "Folgen Sie uns auf sozialen Medien und teilen Sie Ihr Feedback.",
            ...
            app: {
                ...
                create_new_domian: "Neue Domäne erstellen",
        ...
        FR: {
            landing: {
                login: "Connexion",
                signup: "S'inscrire",
                hero_title: "Trouvez des informations rapidement",
                hero_description: "ragchat est votre bibliothèque intelligente alimentée par l'IA",
                ...
                upload_documents_description: "Téléchargez vos documents et transformez-les en une bibliothèque intelligente alimentée par l'IA.",
                chat_information_title: "Discutez pour obtenir des informations",
                chat_information_description: "Discutez avec vos documents via des conversations naturelles alimentées par l'IA.",
                source_validation_title: "Validation des sources",
                source_validation_description: "Obtenez des références précises pour chaque réponse.",
                connected_documents_title: "Documents connectés",
                connected_documents_description: "Analysez les relations entre vos documents.",
                demo_title: "Voir ragchat en action",
                personal_researcher_title: "Votre chercheur personnel",
                personal_researcher_description: "Améliorez vos recherches académiques avec ragchat.",
                fast_analysis_title: "Analyse rapide et précise",
                fast_analysis_description: "Transformez vos documents professionnels en informations exploitables.",
                smart_organization_title: "Organisation intelligente",
                smart_organization_description: "Gérez vos documents avec une organisation intelligente alimentée par l'IA.",
                info_title: "À propos",
                mission_title: "Mission",
                mission_description: "Nous révolutionnons l'accès à l'information.",
                who_we_are_title: "Qui sommes-nous?",
                who_we_are_description: "Créé par des ingénieurs passionnés.",
                what_we_do_title: "Ce que nous faisons",
                what_we_do_description: "ragchat permet des conversations naturelles avec vos documents.",
                contact_title: "Contact",
                contact_description: "Participez à notre voyage bêta.",
            ...
            app: {
                ...
                create_new_domian: "Créer un nouveau domaine",
        ...
        ES: {
            landing: {
                ...
                signup: "Regístrate",
                hero_title: "Encuentra información rápidamente",
                hero_description: "ragchat es tu biblioteca inteligente impulsada por IA",
                cta_get_started: "Comenzar",
                explore_now: "Explorar ahora",
                about_title: "¿Qué es ragchat?",
                upload_documents_title: "Subir documentos",
                upload_documents_description: "Sube tus documentos y conviértelos en una biblioteca inteligente impulsada por IA.",
                chat_information_title: "Chatea para obtener información",
                chat_information_description: "Chatea con tus documentos a través de conversaciones naturales impulsadas por IA.",
                source_validation_title: "Validación de fuentes",
                source_validation_description: "Obtén referencias precisas para cada respuesta.",
                connected_documents_title: "Documentos conectados",
                connected_documents_description: "Analiza relaciones entre tus documentos.",
                demo_title: "Ver ragchat en acción",
                personal_researcher_title: "Tu investigador personal",
                personal_researcher_description: "Mejora tus investigaciones académicas con ragchat.",
                fast_analysis_title: "Análisis rápido y preciso",
                fast_analysis_description: "Transforma tus documentos empresariales en información procesable.",
                smart_organization_title: "Organización inteligente",
                smart_organization_description: "Gestiona tus documentos con una organización inteligente impulsada por IA.",
                info_title: "Sobre nosotros",
                mission_title: "Misión",
                mission_description: "Estamos revolucionando el acceso a la información.",
                who_we_are_title: "¿Quiénes somos?",
                who_we_are_description: "Creado por ingenieros apasionados.",
                what_we_do_title: "Lo que hacemos",
                what_we_do_description: "ragchat permite conversaciones naturales con tus documentos.",
                contact_title: "Contacto",
                contact_description: "Únete a nuestro viaje beta.",
            ...
            app: {
                ...
                sources: "Fuentes",
                resources: "Recursos",
                create_new_domian: "Crear un nuevo dominio",
    ...
    langSelect.addEventListener('change', function(e) {
        currentLang = this.value;
            console.log('Selected Language:', currentLang); // Debugging: Log selected value
